 ...
 * 								LIGHTBOX SLIDER
 * -------------------------------------------------------------------------*/
	function zanevn_orange_themes_lightbox_slider(el,side) {
 ...
 * -------------------------------------------------------------------------*/
	...
	var OT_gallery = {
		...
		NextImage : function (clicked) {
			zanevn_orange_themes_lightbox_slider(clicked,"right");
		...
		PrevImage : function (clicked) {
			zanevn_orange_themes_lightbox_slider(clicked,"left");
