...
(function ($) {
	...
	jQuery(document).on("ready", function() {
		...
		jQuery("strong", ".zanevn-panel-title-tabbed").on("click", function(){
			var thisel = jQuery(this),
				thisindex = thisel.index();
			thisel.addClass("active").siblings(".active").removeClass("active").parent().siblings(".zanevn-panel-inner").children(".zanevn-panel-tab").eq(thisindex).addClass("active").siblings(".active").removeClass("active");
			// To show slider even in tabbed
			// initiateLetsDoSlider();
			var thislider = thisel.parent().siblings(".zanevn-panel-inner").find(".zanevn-panel-tab.active .lets-do-slider");
			if(thislider.length){
		...
		jQuery('.zanevn-photo-gallery-list .item-header').owlCarousel({
			loop: true,
			margin: 20,
			responsiveClass: true,
			items: 1,
		...
		jQuery("#main-menu > ul > li").on("mouseenter", function(){
			if(jQuery('.ot-w-gallery-list .item-header')){
				var carousel = jQuery('.ot-w-gallery-list .item-header').data('owlCarousel');
				if(carousel){
		...
		jQuery(".ot-responsive-menu-header-burger", ".ot-responsive-menu-header").on("click", function(){
			...
			mybody.addClass("ot-responsive-menu-show").addClass("nomorefixd").children(".main-menu-wrapper").css({"margin-top": mex_top});
		...
		jQuery(".ot-responsive-menu-header-burger", ".ot-responsive-menu-content-c-header").on("click", function(){
			...
			if(mybody.hasClass("nomorefixd")){
				...
				setTimeout(function(){
					var mex_top = Math.abs(parseInt(jQuery(".main-menu-wrapper", "body").css("margin-top")));
					jQuery(".main-menu-wrapper", "body").removeAttr("style");
