...
$.getTokenKey = function () {
    var tk = $("input[name='CSRF-TOKEN-KYZIN-FORM']").val();
    return {
        "CSRF-TOKEN-KYZIN-FORM": tk
    }
}

$.kzAjax = function (url, type, dataRequest, callback, errorcallback) {
    $.ajax({
        url: url,
        type: type,
        data: dataRequest,
...
$.kzNotify = function (text, type, width) {
